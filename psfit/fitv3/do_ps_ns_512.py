...
def main():
    ...
    if not os.path.exists('./ps_ns_data'):
        os.mkdir('./ps_ns_data')
    np.save("./ps_ns_data/num_ps.npy", np.array(num_ps_list))
    np.save("./ps_ns_data/chi2dof.npy", np.array(chi2dof_list))
    np.save("./ps_ns_data/norm_beam.npy",np.array(norm_beam_list))
    np.save("./ps_ns_data/norm_error.npy",np.array(norm_error_list))
    np.save("./ps_ns_data/fit_lon.npy",np.array(fit_lon_list))
    np.save("./ps_ns_data/fit_lat.npy",np.array(fit_lat_list))
