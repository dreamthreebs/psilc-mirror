...
if __name__ == '__main__':
    ...
    obj = FitPointSource(m=m, nstd=nstd, flux_idx=flux_idx, df_mask=df_mask, df_ps=df_ps, cl_cmb=None, lon=lon, lat=lat, iflux=iflux, lmax=lmax, nside=nside, radius_factor=0.6, beam=beam)
