...
if __name__ == '__main__':
    # m = np.load('../../fitdata/synthesis_data/512/PSNOISE/40/0.npy')[0]
    m = np.load('../../fitdata/synthesis_data/512/PSCMBFGNOISE/40/0.npy')[0]
    ...
    obj.calc_covariance_matrix(mode='cmb+noise', cmb_cov_fold='../cov_r_1.5_512/cov')
