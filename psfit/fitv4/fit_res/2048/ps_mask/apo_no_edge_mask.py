...
if __name__=='__main__':
    ...
    mask_raw = np.load("/afs/ihep.ac.cn/users/w/wangyiming25/work/dc2/psilc/psfit/fitv4/fit_res/2048/ps_mask/no_edge_mask/C1_5.npy")
    ...
    save_path = "./no_edge_mask/C1_5APO_8.npy"
