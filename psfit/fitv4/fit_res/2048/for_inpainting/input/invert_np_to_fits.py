...
#     print(f'{rlz_idx=}')
#     m = np.load(f'../../../../../../fitdata/synthesis_data/2048/PSCMBFGNOISE/40/{rlz_idx}.npy')[0].copy()
#     hp.write_map(f'./pfcn/{rlz_idx}.fits', m, overwrite=True)
...
if __name__ == '__main__':  # This check is necessary for multiprocessing to work on Windows
    with Pool(num_processes) as pool:
        pool.map(process_file, range(50,100))
