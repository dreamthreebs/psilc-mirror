...
def main1():
    ...
    np.save("./fit_data1/norm_beam.npy",np.array(norm_beam_list))
    np.save("./fit_data1/fit_lon.npy",np.array(fit_lon_list))
    np.save("./fit_data1/fit_lat.npy",np.array(fit_lat_list))
    np.save("./fit_data1/norm_error.npy",np.array(norm_error_list))
