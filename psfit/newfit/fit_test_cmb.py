    ...
    def fit_all(self, mode:str='pipeline'):
        ...
        def fit_1_params():
            ...
            if obj_minuit.fmin.hesse_failed:
                ...
                return chi2dof, obj_minuit.values['const'],obj_minuit.errors['const'], self.lon, self.lat

        chi2dof, fit_const, const_error, fit_lon, fit_lat = fit_1_params()
...
if __name__ == '__main__':
    ...
    obj.calc_covariance_matrix(mode='cmb', cmb_cov_fold='./covlmin/200')
    obj.fit_all()
