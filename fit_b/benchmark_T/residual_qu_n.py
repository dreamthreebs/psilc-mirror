...
class GetResidual:
    ...
    def pcn_res(self, mask, threshold=2):
        ...
        for flux_idx in range(10):
            ...
            fit_lon = np.load(f'./fit_res/pcn_params/fit_qu_lon_lat_n/idx_{flux_idx}/fit_lon_{rlz_idx}.npy')
            fit_lat = np.load(f'./fit_res/pcn_params/fit_qu_lon_lat_n/idx_{flux_idx}/fit_lat_{rlz_idx}.npy')
        ...
        path_for_res_map = Path(f'./fit_res/pcn_fit_qu_n/{threshold}sigma')
