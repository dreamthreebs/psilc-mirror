...
class FitPolPS:
    ...
    def fit_all(self, cov_mode:str, mode:str='pipeline'):
        ...
        if mode == 'pipeline':
            ...
            fit_q_amp = fit_q_amp / self.nside2pixarea_factor
            fit_q_amp_err = fit_q_amp_err / self.nside2pixarea_factor
            fit_u_amp = fit_u_amp / self.nside2pixarea_factor
            fit_u_amp_err = fit_u_amp_err / self.nside2pixarea_factor
