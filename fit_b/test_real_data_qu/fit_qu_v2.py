...
class FitPolPS:
    ...
    def fit_all(self, cov_mode:str, mode:str='pipeline'):
        ...
        def fit_1_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000), (-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_2_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_3_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_4_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_5_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_6_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_7_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        def fit_8_ps():
            ...
            obj_minuit.limits = [(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-2000,2000),(-500,500), (-500,500)]
            logger.debug(f'\n{obj_minuit.migrad()}')
            logger.debug(f'\n{obj_minuit.hesse()}')
        ...
        if mode == 'pipeline':
            ...
            fit_q_amp = fit_q_amp
            fit_q_amp_err = fit_q_amp_err
            fit_u_amp = fit_u_amp
            fit_u_amp_err = fit_u_amp_err
