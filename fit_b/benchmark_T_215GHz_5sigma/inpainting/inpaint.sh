...
mrs_alm_inpainting -v -m 2 -l 2500 ./input_m2/${number}.fits ./mask/mask1d8.fits ./output_m2/${number}.fits
mrs_alm_inpainting -v -m 2 -l 2500 ./input_m2_n/${number}.fits ./mask/mask1d8.fits ./output_m2_n/${number}.fits
