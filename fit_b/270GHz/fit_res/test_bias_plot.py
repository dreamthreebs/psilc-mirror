# maybe smoothing may lose information of the unresolved point sources. better to use psm - resolved ps to get good result.
import numpy as np
import healpy as hp
...
dl_psm = np.load(f"./BIAS/test/ps_psm.npy")
dl_smooth = np.load(f"./BIAS/test/ps_smooth.npy")
dl_resolved_ps = np.load(f"./BIAS/test/ps_resolved.npy")
dl_psm_subtract_resolved_ps = np.load(f"./BIAS/test/ps_unresolved.npy")
...
plt.plot(ell_arr, dl_psm[:lmax_ell_arr], label='ps psm', marker='.')
plt.plot(ell_arr, dl_smooth[:lmax_ell_arr], label='ps smooth', marker='.')
plt.plot(ell_arr, dl_resolved_ps[:lmax_ell_arr], label='ps resolved', marker='.')
plt.plot(ell_arr, dl_unresolved_ps[:lmax_ell_arr], label='ps unresolved', marker='.')
plt.plot(ell_arr, dl_psm_subtract_resolved_ps[:lmax_ell_arr], label='psm - resolved', marker='.')
