...
ax_main.errorbar(ell_arr, cfn_mean[:lmax_ell_arr], yerr=cfn_std[:lmax_ell_arr], label='CMB + FG + NOISE', fmt='.')
ax_main.errorbar(ell_arr+5, pcfn_mean[:lmax_ell_arr], yerr=pcfn_std[:lmax_ell_arr], label='PS + CMB + FG + NOISE', fmt='.')
ax_main.errorbar(ell_arr+10, rmv_mean[:lmax_ell_arr], yerr=rmv_std[:lmax_ell_arr], label='Template Fitting method', fmt='.')
ax_main.errorbar(ell_arr+15, ps_mask_mean[:lmax_ell_arr], yerr=ps_mask_std[:lmax_ell_arr], label='Mask on QU', fmt='.')
ax_main.errorbar(ell_arr+20, inp_mean[:lmax_ell_arr], yerr=inp_std[:lmax_ell_arr], label='Recycling + Inpaint on B', fmt='.')
