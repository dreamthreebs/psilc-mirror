...
dl_unresolved_ps = np.load(f"./BIAS/test/ps_unresolved.npy")
dl_mask = np.load(f'./BIAS/mask/bias_all_0.npy')
dl_mask_2degree = np.load(f'./BIAS/mask_2degree/bias_all_0.npy')
dl_mask_3degree = np.load(f'./BIAS/mask_3degree/bias_all_0.npy')
dl_mask_4degree = np.load(f'./BIAS/mask_4degree/bias_all_0.npy')
...
plt.plot(ell_arr, dl_mask[:lmax_ell_arr], label='bias mask ps 1 degree apodize', marker='.')
plt.plot(ell_arr, dl_mask_2degree[:lmax_ell_arr], label='bias mask ps 2 degree apodize', marker='.')
...
# plt.plot(ell_arr, dl_mask_3degree[:lmax_ell_arr], label='bias mask ps 3 degree apodize', marker='.')
# plt.plot(ell_arr, dl_mask_4degree[:lmax_ell_arr], label='bias mask ps 4 degree apodize', marker='.')
plt.loglog()
plt.xlabel(r"$\ell$")
