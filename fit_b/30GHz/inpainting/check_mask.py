...
input_mean = hp.read_map('./input_mean/0.fits')
input_std = hp.read_map('./input_std/0.fits')
input_n = hp.read_map('./input_n/0.fits')

output_mean = hp.read_map('./output_m2_mean/0.fits')
output_std = hp.read_map('./output_m2_std/0.fits')
