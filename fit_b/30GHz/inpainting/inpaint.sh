...
mrs_alm_inpainting -v -m 3 -l 500 ./input_std_new/${number}.fits ./new_mask/mask2d5.fits ./output_m3_std_new/${number}.fits
mrs_alm_inpainting -v -m 3 -l 500 ./input_n_new/${number}.fits ./new_mask/mask2d5.fits ./output_m3_n_new/${number}.fits
