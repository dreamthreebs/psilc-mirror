...
class GetResidual:
    ...
    def pcn_res(self, mask, threshold=2):
        ...
        for flux_idx in range(20):
            ...
            pcn_p_amp = np.load(f'./fit_res/pcn_params/fit_b_1/idx_{flux_idx}/fit_P_{rlz_idx}.npy')
            pcn_phi = np.load(f'./fit_res/pcn_params/fit_b_1/idx_{flux_idx}/fit_phi_{rlz_idx}.npy')
        ...
        path_for_res_map = Path(f'./fit_res/pcn_fit_b_qu_1/{threshold}sigma')
