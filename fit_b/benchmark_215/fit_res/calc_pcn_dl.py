...
def cpr_spectrum_pcn_b(bin_mask, apo_mask):
    ...
    m_pcn, m_cn, m_c, m_n= gen_b_map(rlz_idx=rlz_idx)
    ...
    m_removal_b = np.load(f'./pcn_fit_b/{threshold}sigma/map_b_{rlz_idx}.npy') * bin_mask
    ...
    dl_c_b = calc_dl_from_scalar_map(m_c, bl, apo_mask=apo_mask, bin_dl=bin_dl, masked_on_input=False)
    dl_cn_b = calc_dl_from_scalar_map(m_cn, bl, apo_mask=apo_mask, bin_dl=bin_dl, masked_on_input=False)
    dl_pcn_b = calc_dl_from_scalar_map(m_pcn, bl, apo_mask=apo_mask, bin_dl=bin_dl, masked_on_input=False)
    dl_n_b = calc_dl_from_scalar_map(m_n, bl, apo_mask=apo_mask, bin_dl=bin_dl, masked_on_input=False)
