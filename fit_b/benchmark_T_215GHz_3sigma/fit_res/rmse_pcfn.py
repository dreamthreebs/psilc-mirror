...
path_save = Path('/afs/ihep.ac.cn/users/w/wangyiming25/tmp/20241021')
path_save.mkdir(exist_ok=True, parents=True)
plt.savefig(path_save / Path('215GHz_217ps_rmse.png'), dpi=300)
...
path_save = Path('/afs/ihep.ac.cn/users/w/wangyiming25/tmp/20241021')
path_save.mkdir(exist_ok=True, parents=True)
plt.savefig(path_save / Path('cpr_results_215GHz_217ps.png'), dpi=300)
