...
class Fit_on_B:
    ...
    def params_for_fitting(self):
        ...
        logger.info(f'{self.ipix_disc.shape=}, {self.ndof=}')
        ...
        logger.info(f'{normed_vec_ctr_to_disc=}')
    ...
    def fit_b(self):
        ...
        logger.info(obj_minuit.migrad())
        logger.info(obj_minuit.hesse())
