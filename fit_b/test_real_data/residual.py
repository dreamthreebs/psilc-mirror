...
noise_seeds = np.load('./seeds_noise.npy')
cmb_seeds = np.load('./seeds_cmb.npy')
...
class GetResidual:
    ...
    def pcn_generator(self, rlz_idx):
        nside = self.nside
        ...
        # pcn_b = np.load('./1_6k_pcn.npy')
        # cn_b = np.load('./1_6k_cn.npy')
    ...
    def pcn_res(self, threshold=2):
        ...
        m_pcn_b, m_cn_b = self.pcn_generator(rlz_idx=rlz_idx)
        ...
        for flux_idx in range(213):
            ...
            pcn_p_amp = np.load(f'./fit_res/pcn_params/idx_{flux_idx}/fit_P_{rlz_idx}.npy')
            pcn_phi = np.load(f'./fit_res/pcn_params/idx_{flux_idx}/fit_phi_{rlz_idx}.npy')

            pcn_p_amp_true = np.load(f'./fit_res/pcn_params/idx_{flux_idx}/P_{rlz_idx}.npy')
            pcn_phi_true = np.load(f'./fit_res/pcn_params/idx_{flux_idx}/phi_{rlz_idx}.npy')
