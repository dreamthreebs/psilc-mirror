...
mrs_alm_inpainting -v -m 2 -l 500 ./input/${number}.fits ./mask/mask1d8.fits ./output/${number}.fits
mrs_alm_inpainting -v -m 2 -l 500 ./input_n/${number}.fits ./mask/mask1d8.fits ./output_n/${number}.fits
