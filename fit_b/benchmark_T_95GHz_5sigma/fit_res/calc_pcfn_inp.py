...
def cpr_spectrum_pcn_b(bin_mask, apo_mask):
    ...
    m_inp_eb_b = hp.read_map(f'../inpainting/output_1108_pcfn_m2_l1k_edge/{rlz_idx}.fits') * bin_mask
    m_inp_eb_b_n = hp.read_map(f'../inpainting/output_1108_n_m2_l1k_edge/{rlz_idx}.fits') * bin_mask
    ...
    path_dl_qu = Path(f'pcfn_dl/INP_1108/inp_hole_m2_pcfn')
    path_dl_qu_n = Path(f'pcfn_dl/INP_1108/inp_hole_m2_n')
