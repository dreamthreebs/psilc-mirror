...
for rlz_idx in range(0,200):
    ...
    # n_inp = np.load(f'./pcfn_dl/INP/inp_edge_m2_n/{rlz_idx}.npy')
    n_inp = np.load(f'./pcfn_dl/INP_1108/inp_edge_m2_n/{rlz_idx}.npy')
    ...
    # inp_eb = np.load(f'./pcfn_dl/INP/inp_edge_m2_pcfn/{rlz_idx}.npy') - n_inp
    inp_eb = np.load(f'./pcfn_dl/INP_1108/inp_edge_m2_pcfn/{rlz_idx}.npy') - n_inp
    # inp_eb_1101 = np.load(f'./pcfn_dl/RMV/inp_3nside/{rlz_idx}.npy') - n_inp
    ...
    # plt.plot(ell_arr, inp_eb_1101, label=f'inp 1101 {rlz_idx}')
