...
def check_inp():
    ...
    plt.semilogy(ell_arr, inp_1_mean, label='inp m2 no point source mask')
    plt.semilogy(ell_arr, inp_2_mean, label='inp m3 no point source mask')
    plt.semilogy(ell_arr, inp_3_mean, label='inp m2 with point source mask')
    plt.semilogy(ell_arr, inp_4_mean, label='inp m3 with point source mask')
    plt.legend()
    plt.xlabel('$\\ell$')
    ...
    plt.semilogy(ell_arr, inp_1_std, label='inp m2 no point source mask')
    plt.semilogy(ell_arr, inp_2_std, label='inp m3 no point source mask')
    plt.semilogy(ell_arr, inp_3_std, label='inp m2 with point source mask')
    plt.semilogy(ell_arr, inp_4_std, label='inp m3 with point source mask')
    plt.xlabel('$\\ell$')
    plt.ylabel('$\\Delta D_\\ell [\\mu K^2]$')
