...
fig1, ax_main = plt.subplots(figsize=(6, 5))
fig2, ax_sub = plt.subplots(figsize=(6, 5))
...
ax_main.set_xlabel('$\\ell$')
ax_main.set_ylabel('Residual and Std Deviation')
...
ax_sub.plot(ell_arr, res_pcfn[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='PS + CMB + FG + NOISE', marker='.', color='blue')
ax_sub.plot(ell_arr, res_rmv[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Template Fitting method', marker='.', color='green')
ax_sub.plot(ell_arr, res_cfn[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='CMB + FG + NOISE', marker='.', color='black')
ax_sub.plot(ell_arr, res_inp[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Recycling + Inpaint on B', marker='.', color='red')
ax_sub.plot(ell_arr, res_ps_mask[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Mask on QU', marker='.', color='orange')
...
ax_sub.plot(ell_arr, pcfn_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='PS + CMB + FG + NOISE', color='blue', marker='.', linestyle=':')
ax_sub.plot(ell_arr, rmv_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Template Fitting method', color='green', marker='.', linestyle=':')
ax_sub.plot(ell_arr, cfn_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='CMB + FG + NOISE', color='black', marker='.', linestyle=':')
ax_sub.plot(ell_arr, ps_mask_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Mask on QU', color='orange', marker='.', linestyle=':')
ax_sub.plot(ell_arr, inp_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Recycling + Inpaint on B', color='red', marker='.', linestyle=':')
