...
ax_main.errorbar(ell_arr*0.985, pcfn_mean[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], yerr=pcfn_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='with-PS baseline', fmt='.', color='blue')
ax_main.errorbar(ell_arr*0.995, cfn_mean[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], yerr=cfn_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='no-PS baseline', fmt='.', color='purple')
ax_main.plot(ell_arr, dl_in[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='Fiducial CMB', color='black')
ax_main.errorbar(ell_arr*1.005, rmv_mean[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], yerr=rmv_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='TF', fmt='.', color='green')
ax_main.errorbar(ell_arr*1.015, ps_mask_mean[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], yerr=ps_mask_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='M-QU', fmt='.', color='orange')
ax_main.errorbar(ell_arr*1.025, inp_mean[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], yerr=inp_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='RI-B', fmt='.', color='red')
ax_main.errorbar(ell_arr*1.03, masking_mean[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], yerr=masking_std[:lmax_ell_arr]/cfn_mean[:lmax_ell_arr], label='MASK', fmt='.', color='yellow')
