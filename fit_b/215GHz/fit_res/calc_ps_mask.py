...
def cpr_spectrum_pcn_b(bin_mask, apo_mask):
    ...
    path_dl_qu_pcfn = Path(f'pcfn_dl/PS_MASK/MEAN/pcfn')
    path_dl_qu_cfn = Path(f'pcfn_dl/PS_MASK/MEAN/cfn')
    path_dl_qu_cf = Path(f'pcfn_dl/PS_MASK/MEAN/cf')
    path_dl_qu_n = Path(f'pcfn_dl/PS_MASK/MEAN/n')
