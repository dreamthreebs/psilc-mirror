...
mrs_alm_inpainting -v -m 2 -l 2500 ./input_mean/${number}.fits ./mask/mask1d8.fits ./output_m2_mean/${number}.fits
mrs_alm_inpainting -v -m 2 -l 2500 ./input_std/${number}.fits ./mask/mask1d8.fits ./output_m2_std/${number}.fits
mrs_alm_inpainting -v -m 2 -l 2500 ./input_n/${number}.fits ./mask/mask1d8.fits ./output_m2_n/${number}.fits
