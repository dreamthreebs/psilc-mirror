...
mrs_alm_inpainting -v ./input/q_${number}.fits ./mask/mask_1.fits ./output_1/q_${number}.fits
mrs_alm_inpainting -v ./input/u_${number}.fits ./mask/mask_1.fits ./output_1/u_${number}.fits
