...
mrs_alm_inpainting -v ./input/q_${number}.fits ./mask/mask.fits ./output/q_${number}.fits
mrs_alm_inpainting -v ./input/u_${number}.fits ./mask/mask.fits ./output/u_${number}.fits
