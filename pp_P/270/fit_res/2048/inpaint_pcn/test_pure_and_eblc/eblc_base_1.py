...
class EBLeakageCorrection:
    def __init__(self, m, lmax, nside, mask, post_mask, method:str='cutqufitqu', check_res:bool=False, n_iter=3, input_slope=None):
    ...
    def cutqufitqu(self, m, lmax, nside):
        ...
        def linear_fitting():
            ...
            slope, intercept = coeffs
            if self.input_slope is not None:
    ...
    def run_eblc(self):
        ...
        return self.crt_b, self.tmp_b, self.cln_b, self.slope
