...
for rlz_idx in range(1,100):
    ...
    rmv = np.load(f'./pcn_dl/E/removal_2sigma/{rlz_idx}.npy') - n
    rmv1 = np.load(f'./pcn_dl/E/removal_3sigma/{rlz_idx}.npy') - n
...
plt.figure(1)
plt.plot(ell_arr, rmv_mean, label='debias rmv_mean 2sigma')
