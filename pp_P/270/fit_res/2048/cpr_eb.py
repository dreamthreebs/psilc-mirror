...
plt.figure(1)
hp.gnomview(pcn_e, rot=[lon, lat, 0], title='pcn e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=241)
hp.gnomview(cn_e, rot=[lon, lat, 0], title='cn e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=242)
hp.gnomview(inp_qu_e, rot=[lon, lat, 0], title='inp qu e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=243)
hp.gnomview(inp_eb_e, rot=[lon, lat, 0], title='inp eb e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=244)
hp.gnomview(m_e, rot=[lon, lat, 0], title='removal e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=245)
hp.gnomview(m_e - cn_e, rot=[lon, lat, 0], title='residual removal e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=246)
...
hp.gnomview(inp_eb_e - cn_e, rot=[lon, lat, 0], title='residual inpaint eb e', xsize=fig_size, ysize=fig_size, min=e_min, max=e_max, sub=248)

plt.figure(2)
hp.gnomview(pcn_b, rot=[lon, lat, 0], title='pcn b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=241)
hp.gnomview(cn_b, rot=[lon, lat, 0], title='cn b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=242)
hp.gnomview(inp_qu_b, rot=[lon, lat, 0], title='inp qu b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=243)
hp.gnomview(inp_eb_b, rot=[lon, lat, 0], title='inp eb b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=244)
hp.gnomview(m_b, rot=[lon, lat, 0], title='removal b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=245)
hp.gnomview(m_b - cn_b, rot=[lon, lat, 0], title='residual removal b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=246)
...
hp.gnomview(inp_eb_b - cn_b, rot=[lon, lat, 0], title='residual inpaint eb b', xsize=fig_size, ysize=fig_size, min=b_min, max=b_max, sub=248)
