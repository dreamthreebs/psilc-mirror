...
plt.scatter(ell_arr, pcn_rmse, label='pcn rmse')
plt.scatter(ell_arr, cn_rmse, label='cn rmse')
plt.scatter(ell_arr, rmv_rmse, label='rmv rmse')
plt.scatter(ell_arr, inp_eb_rmse, label='inp eb rmse')
plt.scatter(ell_arr, ps_mask_rmse, label='ps mask rmse')
plt.xlabel('$\\ell$')
plt.ylabel('$D_\\ell^{BB res} / D_\\ell^{BB cn}$')
# plt.ylim(bottom=1e-10)
plt.loglog()
