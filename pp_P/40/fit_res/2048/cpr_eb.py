...
e_min = -1.5 * np.std(m_proj_cn_E)
e_max = 1.5 * np.std(m_proj_cn_E)
...
b_min = -2.5 * np.std(m_proj_cn_B)
b_max = 2.5 * np.std(m_proj_cn_B)
...
hp.gnomview(m_b - cn_b, rot=[lon, lat, 0], title='residual removal b', xsize=fig_size, ysize=fig_size, min=b_min/10, max=b_max/10, sub=246)
