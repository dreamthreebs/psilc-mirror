...
hp.gnomview(m_q - cn_q, rot=[lon, lat, 0], title='residual removal q', xsize=fig_size, ysize=fig_size, min=q_min, max=q_max, sub=224)
...
hp.gnomview(m_u - cn_u, rot=[lon, lat, 0], title='residual removal u', xsize=fig_size, ysize=fig_size, min=u_min, max=u_max, sub=224)
