...
plt.plot(cl_cmb1/cl_cmb, label='cmb 1')
plt.plot(cl_cmb10/cl_cmb, label='cmb 10')
plt.plot(cl_cmb20/cl_cmb, label='cmb 20')
plt.plot(cl_cmbdot1/cl_cmb, label='cmb dot1')
plt.plot(cl_cmbdot5/cl_cmb, label='cmb dot5')
