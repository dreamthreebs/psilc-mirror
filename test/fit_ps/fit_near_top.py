...
idx_pix = 32284 # randomly assign 26106330
ct_theta, ct_phi = hp.pix2ang(nside=nside, ipix=idx_pix, lonlat=True) # center=26106351
...
threshold = 0.1
if np.abs(obj_minuit.values['sigma'] - sigma_true)/sigma_true < threshold:
