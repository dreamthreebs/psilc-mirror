...
cos_theta_set = set(cos_theta_list)
print(f'{len(cos_theta_list)}')
...
#     loaded_itp_funcs = pickle.load(f)
#     cos_theta = 0.99998
#     cov_out = calc_C_theta_itp(x=cos_theta, lmax=lmax, cl=cl[0:lmax+1], itp_funcs=loaded_itp_funcs)
#     print(f'{cov_out=}')
# timecov = time.time()-time0
# print(f'{timecov=}')
...
#     cos_theta = 0.99998
#     time0 = time.time()
#     cov_out = calc_C_theta_itp1(x=cos_theta, lmax=lmax, cl=cl[0:lmax+1], itp_funcs=loaded_itp_funcs)
#     print(f'{cov_out=}')
# timecov = time.time()-time0
# print(f'{timecov=}')
