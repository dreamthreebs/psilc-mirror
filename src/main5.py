...
if __name__ == '__main__':
    ...
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512BAND5/noPS/SIM', save_path_eblc='../data/band5cmbfg/eblc/sim', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')
