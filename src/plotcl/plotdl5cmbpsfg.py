...
if __name__ == '__main__':
    ...
    dl_true_full = calc_dl_from_scalar_map(mtrue, bl, apo_mask=full_mask)
    ...
    plt.plot(ell_arr, dl_true, label='true_partial')
    plt.plot(ell_arr, dl_true_full, label='true_full')
