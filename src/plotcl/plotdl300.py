...
if __name__ == '__main__':
    ...
    mhilc = np.load('../../data/sim300/sim300hilc/hilc_map.npy')
    mnilc = np.load('../../data/sim300/sim300nilc/nilc_map0.npy')
    
    mpfgres = np.load('../../data/sim300/sim300pilc/pilc_fgres_map.npy')
    mhfgres = np.load('../../data/sim300/sim300hilc/hilc_fgres_map.npy')
    mnfgres = np.load('../../data/sim300/sim300nilc/nilc_fgres_map0.npy')
