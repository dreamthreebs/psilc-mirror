...
if __name__ == '__main__':
    ...
    for i in range(n_sim):
        ...
        mpnoiseres = np.load('../../data/noapo/NOISEPILC/pilc_noise_res_map0.npy')
        mhnoiseres = np.load('../../data/noapo/NOISEHILC/hilc_noise_res_map0.npy')
        mnnoiseres = np.load('../../data/noapo/NOISENILC/nilc_noise_res_map0.npy')
        ...
        dl_nnoiseres = dl_pnoiseres + calc_dl_from_scalar_map(mnnoiseres, bl, apo_mask)
