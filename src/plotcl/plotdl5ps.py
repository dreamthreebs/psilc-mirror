...
if __name__ == '__main__':
    ...
    mpilc = np.load('../../data/band5ps1/simpilc/pilc_map.npy')
    mhilc = np.load('../../data/band5ps1/simhilc/hilc_map.npy')
    mnilc = np.load('../../data/band5ps1/simnilc/nilc_map0.npy')
    
    mpfgres = np.load('../../data/band5ps1/simpilc/pilc_fgres_map.npy')
    mhfgres = np.load('../../data/band5ps1/simhilc/hilc_fgres_map.npy')
    mnfgres = np.load('../../data/band5ps1/simnilc/nilc_fgres_map0.npy')

    mpnoiseres = np.load('../../data/band5ps1/simpilc/pilc_noise_res_map.npy')
    mhnoiseres = np.load('../../data/band5ps1/simhilc/hilc_noise_res_map.npy')
    mnnoiseres = np.load('../../data/band5ps1/simnilc/nilc_noise_res_map0.npy')

    apo_mask = np.load('../mask/north/APOMASKC1_2.npy')
    bl = hp.gauss_beam(np.deg2rad(63)/60, lmax=2000, pol=True)[:,2]
    bin_dl = nmt.NmtBin.from_edges([30,80,130,180,230,280,330,380],[80,130,180,230,280,330,380,400], is_Dell=True)
