...
def calc_dl_from_scalar_map(scalar_map, bl, apo_mask):
    scalar_field = nmt.NmtField(apo_mask, [scalar_map], beam=bl, masked_on_input=True)
...
if __name__ == '__main__':
    ...
    mpilc = np.load('../../data/sim/simpilc/pilc_map.npy')
    mhilc = np.load('../../data/sim/simhilc/hilc_map.npy')
    mnilc = np.load('../../data/sim/simnilc/nilc_map0.npy')
    
    mpfgres = np.load('../../data/sim/simpilc/pilc_fgres_map.npy')
    mhfgres = np.load('../../data/sim/simhilc/hilc_fgres_map.npy')
    mnfgres = np.load('../../data/sim/simnilc/nilc_fgres_map0.npy')
