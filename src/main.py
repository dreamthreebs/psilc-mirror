...
if __name__ == '__main__':
    ...
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512/noPS/CMB', save_path_eblc='../data/sim/eblc/cmb', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512/noPS/SIM', save_path_eblc='../data/sim/eblc/sim', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512/noPS/FG', save_path_eblc='../data/sim/eblc/fg', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')

    smooth_eblc_result(lmax_sm=500, nside_sm=512, beam_base=9, path_df='../FGSim/FreqBand', glob_path='../data/sim/eblc/sim', save_path_sm='../data/sim/smsim', path_bin_mask_sm='./mask/north/BINMASKG.npy')
    smooth_eblc_result(lmax_sm=500, nside_sm=512, beam_base=9, path_df='../FGSim/FreqBand', glob_path='../data/sim/eblc/fg', save_path_sm='../data/sim/smfg', path_bin_mask_sm='./mask/north/BINMASKG.npy')

    nilc_pp(lmax_nilc=500, nside_nilc=512, Rtol=1/100, path_apo_mask='./mask/north/APOMASKC1_10.npy', path_bin_mask='./mask/north/BINMASKG.npy', path_sim=f'../data/sim/smsim/data.npy', path_fg=f'../data/sim/smfg/data.npy', needlet_config=f'./eblcilc/needlets/needlet2.csv', save_path_nilc=f'../data/sim/simnilc', number=0)

    hilc_pp(lmax_hilc=500, nside_hilc=512, path_apo_mask='./mask/north/APOMASKC1_10.npy', path_bin_mask='./mask/north/BINMASKG.npy', path_sim=f'../data/sim/smsim/data.npy', path_fg='../data/sim/smfg/data.npy', save_path_hilc='../data/sim/simhilc')
    pilc_pp(lmax_pilc=500, nside_pilc=512, path_apo_mask='./mask/north/APOMASKC1_10.npy', path_bin_mask='./mask/north/BINMASKG.npy', path_sim=f'../data/sim/smsim/data.npy', path_fg='../data/sim/smfg/data.npy', save_path_pilc='../data/sim/simpilc')
