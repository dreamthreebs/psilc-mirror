...
plt.loglog(dl_crp_B, label='crp B cutqu_fitqu apo 8')
plt.loglog(dl_cln_B, label='cln B cutqu_fitqu apo 8')
...
# plt.loglog(dl_crp_B, label='crp B cutqu_fitb')
plt.loglog(dl_cln_B, label='cln B cutqu_fitb apo 8')
...
plt.loglog(dl_crp_B, label='crp B fullqu_fitqu apo 8')
plt.loglog(dl_cln_B, label='cln B fullqu_fitqu apo 8')
...
# plt.loglog(dl_crp_B, label='crp B fullqu_fitb')
plt.loglog(dl_cln_B, label='cln B fullqu_fitb apo 8')
