...
class EBCorrection:
    ...
    def fit_B(self, lmax, nside):
        ...
        self.template_B = self.add_post_mask(slope * self.template_B)
...
np.save(f'./testmethod/zzr/{number}/corrupted_B.npy',corrupted_B)
np.save(f'./testmethod/zzr/{number}/cleaned_B.npy',cleaned_B)
