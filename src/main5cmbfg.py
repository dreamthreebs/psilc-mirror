...
if __name__ == '__main__':
    ...
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512BAND5/noPS/CMB', save_path_eblc='../data/band5cmbfg/eblc/cmb', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512BAND5/noPS/CMBFG', save_path_eblc='../data/band5cmbfg/eblc/sim', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512BAND5/noPS/FG', save_path_eblc='../data/band5cmbfg/eblc/fg', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')
    eblc_at_diff_freq(lmax_eblc=500, nside_eblc=512, glob_path='./sim/NSIDE512BAND5/noPS/NOISE', save_path_eblc='../data/band5cmbfg/eblc/noise', method='cutqufitqu', path_bin_mask_eblc='./mask/north/BINMASKG.npy')

    smooth_eblc_result(lmax_sm=500, nside_sm=512, beam_base=9, path_df='../FGSim/FreqBand5', glob_path='../data/band5cmbfg/eblc/cmb', save_path_sm='../data/band5cmbfg/smcmb', path_bin_mask_sm='./mask/north/BINMASKG.npy')
    smooth_eblc_result(lmax_sm=500, nside_sm=512, beam_base=9, path_df='../FGSim/FreqBand5', glob_path='../data/band5cmbfg/eblc/sim', save_path_sm='../data/band5cmbfg/smsim', path_bin_mask_sm='./mask/north/BINMASKG.npy')
    smooth_eblc_result(lmax_sm=500, nside_sm=512, beam_base=9, path_df='../FGSim/FreqBand5', glob_path='../data/band5cmbfg/eblc/fg', save_path_sm='../data/band5cmbfg/smfg', path_bin_mask_sm='./mask/north/BINMASKG.npy')
    smooth_eblc_result(lmax_sm=500, nside_sm=512, beam_base=9, path_df='../FGSim/FreqBand5', glob_path='../data/band5cmbfg/eblc/noise', save_path_sm='../data/band5cmbfg/smnoise', path_bin_mask_sm='./mask/north/BINMASKG.npy')
