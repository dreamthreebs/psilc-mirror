...
class FitPointSource:
    def __init__(self, m, freq, nstd, flux_idx, df_mask, df_ps, cl_cmb, lon, lat, iflux, lmax, nside, radius_factor, beam, sigma_threshold=5, epsilon=1e-4):
    ...
    def find_nearby_ps(self, num_ps=1):
        ...
        if len(ang) - np.count_nonzero(ang) > 0:
            print(f'there are some point sources overlap')
        ...
        print(f'there are {num_ps} ps > 1 mJy')
    ...
    def fit_all(self, cov_mode:str, mode:str='pipeline'):
        ...
        def fit_5_params():
            ...
            print(f'5 parameter fitting is enough, hesse ok')
        ...
        def fit_6_params():
            ...
            print(f'6 parameter fitting is enough, hesse ok')
        ...
        def fit_8_params():
            ...
            print(f'8 parameter fitting is enough, hesse ok')
        ...
        def fit_9_params():
            ...
            print(f'9 parameter fitting is enough, hesse ok')

            return chi2dof, obj_minuit.values['norm_beam1'], obj_minuit.errors['norm_beam1']


        print(f'begin point source fitting, first do 2 parameter fit...')
        chi2dof, fit_norm, norm_error, fit_lon, fit_lat = fit_2_parameter()
