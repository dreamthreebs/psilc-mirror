...
def plot_dl():
    ...
    plt.figure(1)
    plt.plot(l, pcn_avg[:1001]/100, label='pcn_avg')
    plt.plot(l, cn_avg[:1001]/100, label='cn_avg')
    plt.plot(l, inpaint_avg[:1001]/100, label='inpaint_avg')
    plt.plot(l, removal_avg[:1001]/100, label='removal_avg')
    plt.legend()
    plt.xlabel('$\\ell$')
    ...
    plt.figure(2)
    plt.plot(l, np.sqrt(pcn_var[:1001]), label='pcn_std')
    plt.plot(l, np.sqrt(cn_var[:1001]), label='cn_std')
    plt.plot(l, np.sqrt(inpaint_var[:1001]), label='inpaint_std')
    plt.plot(l, np.sqrt(removal_var[:1001]), label='removal_std')
    plt.legend()
    plt.xlabel('$\\ell$')
    plt.ylabel('$D_\\ell^{TT} [\\mu K^2]$')
    ...
    plt.figure(3)
    plt.plot(l, delta_ps[:1001]/100, label='delta_ps')
    plt.plot(l, delta_removal[:1001]/100, label='delta_removal')
    plt.plot(l, delta_inpaint[:1001]/100, label='delta_inpaint')
    plt.xlabel('$\\ell$')
    plt.ylabel('$D_\\ell^{TT} [\\mu K^2]$')
