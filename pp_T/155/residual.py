...
class GetResidual:
    def __init__(self, flux_idx, m_has_ps, m_no_ps, nstd, lon, lat, df_mask, nside, beam, radius_factor):
...
def main():
    ...
    m_has_ps = np.load('../../fitdata/synthesis_data/2048/PSNOISE/155/1.npy')[0]
