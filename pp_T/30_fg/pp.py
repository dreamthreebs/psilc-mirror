...
def save_fit_res_to_csv(freq):
    ...
    for rlz_idx in range(100):
        ...
        for flux_idx in range(136):
            print(f'{flux_idx=}')
            fit_norm_arr[flux_idx] = np.load(f'./fit_res/2048/PSCMBFGNOISE/1.5/idx_{flux_idx}/norm_beam.npy')[rlz_idx]
            norm_error_arr[flux_idx] = np.load(f'./fit_res/2048/PSCMBFGNOISE/1.5/idx_{flux_idx}/norm_error.npy')[rlz_idx]
            fit_error_arr[flux_idx] = np.load(f'./fit_res/2048/PSCMBFGNOISE/1.5/idx_{flux_idx}/fit_error.npy')[rlz_idx]
        ...
        path_csv = Path('./fit_res/2048/PSCMBFGNOISE/1.5/csv')
