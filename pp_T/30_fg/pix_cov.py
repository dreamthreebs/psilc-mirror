...
def test_fg_cl():
    Cl_TT = np.load('../../fit_b/Cl_fg/data/cl_fg_TT.npy')
    Cl_EE = np.load('../../fit_b/Cl_fg/data/cl_fg_EE.npy')
    Cl_BB = np.load('../../fit_b/Cl_fg/data/cl_fg_BB.npy')
...
def main_cmb():
    ...
    MP = obj.run_calc_cov()
    path_test_class_cov = Path('./cmb_cov')
