...
# m30 = hp.read_map('./30arcmin/INPAINT/1.0/95.fits', field=0)
m17 = hp.read_map('./17arcmin/INPAINT/1.0/95.fits', field=0)
m11 = hp.read_map('./11arcmin/INPAINT/1.0/95.fits', field=0)
m9 = hp.read_map('./9arcmin/INPAINT/1.0/95.fits', field=0)
...
hp.mollview(m_diff_11, norm='hist', title='m_diff_11')
plt.show()
